...
const lessons = [
  Lesson(
      ...
      subtitle: 'Làm quen và giới thiệu bản thân',
      level: 'HSK 1 · 8 phút',
      progress: 1,
      icon: '你',
      color: 0xFFE9F3ED),
  Lesson(
      ...
      subtitle: 'Hỏi giờ, ngày và giá tiền',
      level: 'HSK 1 · 12 phút',
      progress: .65,
      icon: '时',
      color: 0xFFFFEEE2),
  Lesson(
      title: 'Gọi món ăn',
      subtitle: 'Giao tiếp tự nhiên tại nhà hàng',
      level: 'HSK 2 · 15 phút',
      progress: .2,
      icon: '吃',
      color: 0xFFE8EFFA),
  Lesson(
      ...
      subtitle: 'Giới thiệu các thành viên',
      level: 'HSK 2 · 14 phút',
      progress: 0,
      icon: '家',
      color: 0xFFF3E9F4),
  Lesson(
      title: 'Hỏi đường',
      subtitle: 'Phương hướng và di chuyển',
      level: 'HSK 2 · 18 phút',
      progress: 0,
      icon: '路',
      color: 0xFFFFF3D9),
