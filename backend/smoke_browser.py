    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        try:
            ...
            with sync_playwright() as playwright:
                ...
                editor.get_by_label("Chữ Hán", exact=True).fill("测")
                ...
                expect(page.get_by_role('cell',name='测',exact=True)).to_be_visible()
                row = page.locator('tr').filter(has=page.get_by_role('cell', name='测', exact=True))
