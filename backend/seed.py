...
WORDS = [
    ...
    ("你好", "nǐ hǎo", "xin chào", 1, "你好！很高兴认识你。", [
        stroke((180, 180), (110, 420)), stroke((155, 360), (155, 850)),
        stroke((280, 180), (225, 340)), stroke((250, 330), (415, 330), (370, 440)),
        stroke((325, 380), (325, 820), (275, 860)), stroke((270, 530), (210, 720)),
        stroke((375, 530), (430, 720)),
        stroke((670, 210), (620, 560), (745, 740)), stroke((730, 340), (670, 640), (580, 800)),
        stroke((570, 510), (760, 510)), stroke((790, 270), (920, 270), (840, 430)),
        stroke((860, 420), (860, 790), (810, 850)), stroke((740, 560), (950, 560))]),
    ("学习", "xué xí", "học tập", 1, "我学习汉语。", [
        stroke((220, 160), (250, 240)), stroke((310, 150), (310, 230)),
        stroke((400, 160), (360, 250)), stroke((160, 340), (190, 420)),
        stroke((170, 350), (440, 350), (400, 440)),
        stroke((240, 490), (370, 490), (260, 620), (360, 620)),
        stroke((310, 490), (310, 860), (260, 820)), stroke((140, 670), (460, 670)),
        stroke((600, 310), (900, 310), (900, 780), (830, 840)),
        stroke((710, 440), (780, 530)), stroke((620, 750), (800, 660))]),
...
def seed():
    ...
    with database() as conn:
        ...
        for hanzi, pinyin, meaning, hsk, example, strokes in WORDS:
            ...
            audio_name = 'word-' + '-'.join(f'{ord(c):x}' for c in hanzi) + '.mp3'
            if (Path(__file__).parent / 'media' / audio_name).is_file():
                conn.execute("UPDATE vocabulary SET audio_url=?,version=version+1 WHERE hanzi=? AND audio_url=''",
                             ('/media/' + audio_name, hanzi))
